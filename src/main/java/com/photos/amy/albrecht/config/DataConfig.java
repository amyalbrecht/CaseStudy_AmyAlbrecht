package com.photos.amy.albrecht.config;
...
@EnableJpaRepositories("com.photos.amy.albrecht.repo")
...
public class DataConfig {
	...
	public LocalContainerEntityManagerFactoryBean getEntityManagerFactoryBean() {
		...
		emfBean.setPersistenceUnitName("photos");
		emfBean.setPackagesToScan("com.photos.amy.albrecht.models");
